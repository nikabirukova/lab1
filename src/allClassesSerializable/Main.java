...
import allClassesSerializable.FileOperations.FileSerializationReader;
import allClassesSerializable.FileOperations.FileSerializationWriter;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Library library = new Library("Andrew Klochko Central Library");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "8":
                    ...
                    break;
                case "9":
                    FileSerializationWriter.objectToFile(library, "src\\allClassesSerializable\\Files\\serializableLibrary.txt");
                    break;
                case "a":
                    library = (Library) FileSerializationReader.objectFromFile("src\\allClassesSerializable\\Files\\serializableLibrary.txt");
                    break;
                case "0":
                    return;
            }
