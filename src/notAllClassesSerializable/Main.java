...
import notAllClassesSerializable.FileOperations.FileSerializationReader;
import notAllClassesSerializable.FileOperations.FileSerializationWriter;
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "8":
                    ...
                    break;
                case "9":
                    FileSerializationWriter.objectToFile(library, "src\\notAllClassesSerializable\\Files\\serializableLibrary.txt");
                    break;
                case "a":
                    library = (Library) FileSerializationReader.objectFromFile("src\\notAllClassesSerializable\\Files\\serializableLibrary.txt");
                    break;
                case "0":
                    return;
            }
